<script lang="ts">
	...
	function addStars(numStars: number): void {
...
<div class="relative flex overflow-hidden h-[85vh]">
	<div id="star-container"></div>
	<div class="absolute top-0 left-0 w-full h-full">
		<div class="z-[5] flex absolute bottom-0 left-1/2 flex-col min-w-full max-h-full -translate-x-1/2 min-h-1/2 w-[2500px]">
			<svg
				viewBox="0 0 4000 1000"
				xmlns="http://www.w3.org/2000/svg"
				class="block translate-y-[40%] h-auto max-w-full fill-[url(#horizon)]"
			>
				<defs>
					<linearGradient id="horizon" x1="0%" x2="0%" y1="0%" y2="100%">
						<stop offset="10%" stop-color="#111111" />
	...
	<div class="absolute opacity-40 bg-secondary-900 w-[50%] left-[10%] top-[50%] aspect-square rounded-full blur-2xl z-[2]"></div>
</div>

<div class="floor relative bottom-0 w-full h-[15vh] bg-base-200 overflow-hidden"></div>
...
<style>
	.floor::before {
		...
		position: absolute;
		inset: -10px;
		background: radial-gradient(farthest-side ellipse at center 25%, transparent, theme('colors.base.600') 60%);
	}
</style>
